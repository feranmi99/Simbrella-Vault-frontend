        ...
        <div className="bg-white rounded-xl shadow-md p-4">
            ...
            <div className="grid grid-cols-3 gap-3">
                {actions.map((action, index) => (
                    <button
                        key={index}
                        className={`flex flex-col cursor-pointer items-center justify-center p-4 rounded-lg ${action.color} transition-all transform hover:scale-105 hover:shadow-lg active:scale-95`}
                    >
